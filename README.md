...
export const personalData = {
  ...
  resume: "https://drive.google.com/file/d/1rRJaxbpnVK0jxyvfKjMJmgbK3s77egEf/view?usp=sharing"
};
```

`saidurtech` is used for fetching blog posts from `dev.to`.
